...
class qa_html_theme_base
{
	...
	public function head_custom()
	{
		...
		$this->output('<link rel="canonical" href="' .htmlspecialchars($_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']). '"/>');
	...
	{
	$reklamsiz_ek="";
	if (isset($_SESSION['reklam']))
		{
			
			 if ($_SESSION['reklam'] + 12 * 60 * 60 > time()) 
			 {
			 $reklamsiz_ek="?ref=TWc9PSZ4dXF2VmQ1amhCZ0V6Ykh6d05QSDl";
			 }
		}
	...
	public function main()
	{
		...
		if($this->template =='questions'){
			$this->output('<script type="application/ld+json">
{
    "@context": "https://schema.org",
    "@type": "CollectionPage",
    "id": "'.$this->content['canonical'].'",
    "url": "'.$this->content['canonical'].'",
  ...
  "@type": "Person",
  "url": "https://'.htmlspecialchars($_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']).'",
  "name": "'.str_replace('Kullanıcı: ','', $this->content['title']).'"
}</script>');
		}
		if($this->template == 'qa'){
			$this->output('<script type="application/ld+json">[
   {
      ...
      "@graph":[
        
         {
            ...
            "@id":"https://test.annelertoplandik.com/#qam-topbar",
            "name":"Anasayfa",
            "url":"https://test.annelertoplandik.com/"
         },

                  {
            "@context":"https:\/\/schema.org",
            "@type":"SiteNavigationElement",
            "@id":"https://test.annelertoplandik.com/sorular/#qam-topbar",
            "name":"Sorular",
            "url":"https://test.annelertoplandik.com/sorular"
         },
                  {
            "@context":"https:\/\/schema.org",
            "@type":"SiteNavigationElement",
            "@id":"https://test.annelertoplandik.com/cevapsiz/#qam-topbar",
            "name":"Cevaplanmamış",
            "url":"https://test.annelertoplandik.com/cevapsiz"
         },
                  {
            "@context":"https:\/\/schema.org",
            "@type":"SiteNavigationElement",
            "@id":"https://test.annelertoplandik.com/kategoriler/#qam-topbar",
            "name":"Kategoriler",
            "url":"https://test.annelertoplandik.com/kategoriler"
         },
                  {
            "@context":"https:\/\/schema.org",
            "@type":"SiteNavigationElement",
            "@id":"https://test.annelertoplandik.com/users/#qam-topbar",
            "name":"Kullanıcılar",
            "url":"https://test.annelertoplandik.com/users"
         },
                  {
            "@context":"https:\/\/schema.org",
            "@type":"SiteNavigationElement",
            "@id":"https://test.annelertoplandik.com/sor/#qam-topbar",
            "name":"Bir Soru Sor",
            "url":"https://test.annelertoplandik.com/sor"
         },
                  {
            "@context":"https:\/\/schema.org",
            "@type":"SiteNavigationElement",
            "@id":"https://annelertoplandik.com/forum/#qam-topbar",
            "name":"Konu Dışı Soru&Sohbet",
            "url":"https://annelertoplandik.com/forum/"
         },
           {
            "@context":"https:\/\/schema.org",
            "@type":"SiteNavigationElement",
            "@id":"https://hamilesorucevap.annelertoplandik.com/#qam-topbar",
            "name":"Hamile Soru Cevap",
...
]</script><script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "WebSite",
      "url": "https://annelertoplandik.com/",
      "potentialAction": {
        "@type": "SearchAction",
        "target": "https://annelertoplandik.com/forum/arama?text={search_term_string}&searchid=2336009",
    ...
    </script><script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "Organization",
  "name": "Annelertoplandik.com",
  "url": "https://annelertoplandik.com/forum/",
  "logo": "https://annelertoplandik.com/wp-content/uploads/2019/09/basliklogo.png",
  "sameAs": [
    "https://www.facebook.com/annelertoplandik",
    "https://www.instagram.com/annelertoplandik/",
    "https://www.linkedin.com/in/koksaliyigun/",
    "https://twitter.com/annelertoplandk",
    "https://www.youtube.com/channel/UCl7HCfLz691K0tgXpft40fQ"
  ]
}
</script>');
		}
		...
		if($this->template == 'feedback'){
			$this->output('<script type="application/ld+json">{ "@context":"https:\/\/schema.org", "@type":"ContactPage", "mainEntityOfPage":{ "@type":"WebPage", "@id":"https://annelertoplandik.com/feedback" }, "url":"https://annelertoplandik.com/feedback", "headline":"İletişim", "description":"İletişim sayfası." }</script>');
		}
