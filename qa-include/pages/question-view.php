...
function qa_page_q_post_rules($post, $parentpost = null, $siblingposts = null, $childposts = null)
{
	...
	{
			$rules['editable'] = $post['views']<800 && $rules['editbutton'] && ($rules['isbyuser'] || !$permiterror_edit);
	...
	{
		$rules['hideable'] =  $post['views']<400 && !$post['hidden'] && ($rules['isbyuser'] || !$post['queued']) && !$permiterror_hide_show_self
			&& ($notclosedbyother || !$permiterror_hide_show);
	}
