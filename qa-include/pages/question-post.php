...
$m_hatalibaslik='Soru başlığı sorunuzu kısaca özetleyecek şekilde belirlenmelidir. Bu tarz soru başlıkları platform kullanışlılığını azalttığı için soru kapatılmıştır.';
$m_siddet = "Haklı veya haksız platformda kaba söz içeren veya tahrik edici içerik paylaşmak yasaktır. Aksi taktirde yaptırımla karşılaşmak zorunda kalırsınız. Eğer kurallara aykırı mesaj yazılmışsa uyarı butonuna basarak bizlere bildirmeniz yeterli.";
$m_tekrarkonu="Aynı sorunun tekrar tekrar paylaşılması yasaktır. Sorunuzu paylaşatıktan sonra cevaplanması için beklemeniz gerekmektedir.";
$m_yanlisbolum="Sohbet amaçlı açılan konular yasaktır. Menüden konu dışı sorular için ayrılmış alanda konunuzu açabilirsiniz..";
if (qa_get_logged_in_level() >= QA_USER_LEVEL_EDITOR) {
$haziruyarimesaji =  array(
            'id' => 'otomesajf',
			'label' => '<i style="font-size:11px;color:gray;">Otomatik Kapatma Mesajı:</i>',
			'type' => 'select',
			...
			'options' => array(
                                ...
                                $m_yanlisbolum => "Sohbet İçerikli konu",
                                ),
		);
...
$qa_content['custom'] = '<script> $("#otomesaj").on("change", function () {   document.getElementById("q_close_details").value = document.getElementById("otomesaj").value;})</script>';
