...
class qa_html_theme_layer extends qa_html_theme_base
{
				...
				<div id="flagbox-center">
					<div class="qa-flag-reasons-wrap">
						...
						<label>
							...
							<span>'.q2apro_flag_reasonid_to_readable(5).'(Asagida belirtiniz)</span>
						</label>
				<!--		<label>
						...
						<div class="qa-spam-reason-text-wrap">
							...
							<br>
							<textarea type="text" rows="2" name="qa-spam-reason-text" class="qa-spam-reason-text" placeholder="'.qa_lang('q2apro_flagreasons_lang/enter_details').'"></textarea>
						</div>
	...
	public function post_tags($post, $class)
	{
		...
		if($class=='qa-q-view')
		{
			...
			{
				$flagsout = '
				<b>Asagidaki sebeplerle '.count($flagreasons).' kez uyarildi</b><br>
				...
				foreach($flagreasons as $f)
				{
					...
					$flagsout .= '
					<li>
						<span class="flagreason-what">🚩 '.$reason.'</span> '.$notice.'
					</li>
					';}
