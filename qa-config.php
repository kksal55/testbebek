...
//	define('QA_MYSQL_USERNAME', 'annelertoplandik_bebek_kullanici');
//	//define('QA_MYSQL_USERNAME', 'anne_sorucmart');
//	define('QA_MYSQL_PASSWORD', '^fdf&qNMN~NP');
//	define('QA_MYSQL_DATABASE', 'annelertoplandik_bebek_soru_db');

    define('QA_MYSQL_HOSTNAME', 'localhost'); // try '127.0.0.1' or 'localhost' if MySQL on same server
	define('QA_MYSQL_USERNAME', 'benimhikaye_test');
	define('QA_MYSQL_PASSWORD', 'Test.proje');
	define('QA_MYSQL_DATABASE', 'benimhikaye_proje_bebek_db');
...
*/
define('QA_BLOBS_DIRECTORY', 'qa-medya');
/*
...
/*
	...
	define('QA_COOKIE_DOMAIN', '.https://hamilesorucevap.annelertoplandik.com'); // be sure to keep the leading period
*/
