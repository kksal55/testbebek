...
class qa_html_theme extends qa_html_theme_base
{
	...
	public function head_metas()
	{
		...
		$url = isset($this->content['canonical']) ? $this->content['canonical'] : false;
		$url = str_replace(".com/", ".com/amp/", $url);
		//echo("urk".$url);
        if (strlen($url))
		$this->output('<link rel="amphtml" href="'. $url .'">');
	...
	{
		$this->output('<nav class="qam-main-nav-wrapper clearfix">');
	...
	public function header()
	{
		...
		$this->output('<header id="qam-topbar" class="clearfix' . $class . '">');
	...
	{
		$this->output('<footer class="qam-footer-box">');
	...
	public function attribution()
	{
		...
		$this->output(
			...
			'<a href="http://www.annelertoplandik.com">AnnelerToplandik.com</a>',
			'</div>'
		);
		parent::attribution();
	}
